...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:result-document method="html" encoding="utf-8"
            href="../../_preguntas_respuestas/idno-{$doc_id}.html" omit-xml-declaration="yes">---
            layout: pregunta_respuesta
            title: incipit del otro poema / <xsl:apply-templates select="//title[1]"/>       
            permalink: idno-<xsl:apply-templates select="//$doc_id"/>/
